    ...
    <div class="wrapper clearfix">
        ...
        <ul class="clearfix" id="bott">
           ...
           <c:forEach var="f" items="${father}">
            <li><a href="selectproduct?id=${f.CATE_ID }">${f.CATE_NAME }</a>
                <div class="sList2">
                    <div class="clearfix">
                     <c:forEach var="cl" items="${child}">
                    <c:if test="${cl.CATE_PARENT_ID==f.CATE_ID }">
                    <a href="selectproduct?id=${cl.CATE_ID }">${cl.CATE_NAME}</a>
                   </c:if>
                    </c:forEach>
                    </div>
                </div>
