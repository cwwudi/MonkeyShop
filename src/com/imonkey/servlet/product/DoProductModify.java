...
/**
 * Servlet implementation class DoProductModify
 */
@WebServlet("/manage/admin_doproductmodify")
public class DoProductModify extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		LMONKEY_PRODUCT p=new LMONKEY_PRODUCT(Integer.parseInt(hm.get("id")),hm.get("name"),hm.get("description"),
				Float.parseFloat(hm.get("price")),Integer.parseInt(hm.get("stock")),
				Integer.parseInt(strArr[1]),Integer.parseInt(strArr[0]),fm);
		int count=IMONKEY_PRODUCTDao.updateById(p);
		if(count>0){
